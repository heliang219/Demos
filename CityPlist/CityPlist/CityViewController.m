...
- (void)viewDidLoad
{
    ...
    if (IOS_VERSION >= 7.0) {
        ...
        self.table = [[UITableView alloc] initWithFrame:CGRectMake(0, 94, 320, 480+(iPhone5?88:0) - 94) style:UITableViewStylePlain];
    }
    else{
        lable = [[UILabel alloc] initWithFrame:CGRectMake(5, 44, 180, 30)];
        button.frame = CGRectMake(260, 44, 50, 30);
        self.table = [[UITableView alloc] initWithFrame:CGRectMake(0, 74, 320, 480+(iPhone5?88:0) - 74) style:UITableViewStylePlain];
    }
